...
const SearchBar = ({results,setResults}) => {
 ...
 // const[results,setResults]=useState([]);
  ...
  return (
    <>
      <div className=" mx-auto flex flex-col  items-center mt-[90px] ">
        <div className="text-center space-y-6">
          <div className="flex ">
          <div className=" flex flex-col justify-center items-center ">
          <h1 className=" font-nunito font-bold text-5xl text-[#04a4b3] text-outline ">
            BOOK FINDER
          </h1>
          <p className=" mt-[24px] font-nunito  text-[19px] text-[#97570d] ">
           <span className=" text-[25px] font-semibold text-[#3a3838]">Read. Discover. Repeat. </span><br /> You're at the right place to explore stories that inspire, knowledge that empowers, 
           and imagination that takes you beyond limits.
          </p>
          </div>
          <div className="w-[470px] h-auto mt-20">
            <img src="https://ik.imagekit.io/hb9mevpzq/BOOK%20FINDER/imagemain.png?updatedAt=1757837362348" alt="landing img" />
          </div>

          </div>
          
          <div className="flex w-full max-w-2xl gap-7 mx-auto ">
        ...
        <div className="mt-6 w-full  grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-3 ">
